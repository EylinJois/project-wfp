            ...
            <div class="modal-body">
                ...
                <form id="formAddMember" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="photo" id="add_photo" class="form-control" accept="image/*" required>
                    </div>
                </form>
            </div>
            ...
            if (data.status == "oke") {
                ...
                var newRow = `
                    <tr id="tr_member_${m.id}">
                        ...
                        <td class="px-3 py-2" id="td_updated_${m.id}">${m.updated_at}</td>
                        <td class="px-3 py-2">
