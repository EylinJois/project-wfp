                        ...
                        @foreach ($doctors as $doctor)
                            <tr id="tr_{{ $doctor->id }}">
                                ...
                                @if (@Auth::user()->role == 'admin')
                                    ...
                                    <td class="px-3 py-2" id="td_experience_{{ $doctor->id }}">{{ $doctor->experience }}
                                    </td>
                                    <td class="px-3 py-2" id="td_photo_{{ $doctor->id }}">
                                        <img src="{{ asset('storage/photos/' . $doctor->photo) }}" width="100">
                                    </td>
                                @endif
                                <td class="px-3 py-2" id="td_specialty_id_{{ $doctor->id }}">
                                    {{ $doctor->specialty->name ?? 'N/A' }}</td>
                                <td class="px-3 py-2" id="td_start_time_{{ $doctor->id }}">{{ $doctor->start_time }}
                                </td>
